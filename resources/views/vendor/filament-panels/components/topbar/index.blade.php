...
>
    ...
    >
        ...
        @if (filament()->hasTopNavigation() || (! filament()->hasNavigation()))
            ...
            {{-- Enlace a la ruta raíz --}}
            <div class="me-4 hidden lg:flex">
                <a href="/" class="flex items-center gap-x-2 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-gray-100 transition-colors">
                    <x-filament::icon
