...
--}}
<section class="py-16 bg-white overflow-hidden" data-how-it-works-section>
    <x-partials.container>
        ...
        >
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative">
                    <!-- Línea vertical -->
                    <div class="absolute left-8 top-0 w-0.5 h-full bg-gray-200 z-0"></div>
                    <!-- Línea de progreso -->
                    <div 
                        class="absolute left-8 top-0 w-0.5 bg-gradient-to-b from-blue-600 to-blue-500 transition-all duration-1000 ease-in-out z-0"
                    ...
                    <div class="space-y-8">
                        <template x-for="(step, index) in steps" :key="index">
                            ...
                            >
                                <!-- Círculo del paso -->
                                <div 
                                    class="relative w-16 h-16 rounded-full flex items-center justify-center text-lg font-bold transition-all duration-500 z-20 bg-white border-4"
                                ...
                                >
                                    ...
                                    <div 
                                        class="absolute inset-1 bg-white rounded-full flex items-center justify-center z-30"
                                        x-show="step.active"
                                    >
                                        <span x-text="step.number" class="text-blue-500 font-bold z-30"></span>
                                    </div>
                                    
                                    <!-- Número del paso (cuando no está activo) -->
                                    <span x-show="!step.active" x-text="step.number" class="relative z-30"></span>
                                    ...
                                    >
                                        <i class="fas fa-check text-sm z-50"></i>
                                    </div>
                                </div>
                    ...
                    <div class="relative w-full h-full max-w-lg mx-auto">
                        <template x-for="(step, index) in steps" :key="index">
                            ...
                            >
                                ...
                                <div class="relative">
                                    <!-- Laptop mockup -->
                                    <div class="bg-gray-800 rounded-lg p-2 shadow-2xl transform rotate-1">
                                        <div class="bg-white rounded-md overflow-hidden" style="width: 320px; height: 200px;">
                                            <div class="h-6 bg-gray-100 flex items-center px-3 space-x-1">
                                                <div class="w-2 h-2 bg-red-500 rounded-full"></div>
                                                <div class="w-2 h-2 bg-yellow-500 rounded-full"></div>
                                                <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                                            </div>
                                            <div class="p-4 h-full bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col justify-center items-center">
                                                <div class="text-center">
                                                    <i :class="step.icon" class="text-4xl text-blue-500 mb-3"></i>
                                                    <h4 class="text-sm font-semibold text-gray-800 mb-1" x-text="step.title"></h4>
                                                    <p class="text-xs text-gray-600" x-text="step.shortDescription"></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Phone mockup -->
                                    <div class="absolute -bottom-4 -right-8 bg-gray-800 rounded-2xl p-1 shadow-xl transform -rotate-12 scale-75">
                                        <div class="bg-white rounded-xl overflow-hidden" style="width: 120px; height: 200px;">
                                            <div class="h-2 bg-gray-100"></div>
                                            <div class="px-3 py-2 h-full bg-gradient-to-b from-blue-50 to-blue-100 flex flex-col justify-center items-center">
                                                <i :class="step.icon" class="text-2xl text-blue-500 mb-2"></i>
                                                <div class="text-center">
                                                    <div class="w-16 h-1 bg-gray-300 rounded mb-1"></div>
            ...
            <div class="text-center mt-12">
                <button 
                    ...
                    class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
                >
