...
<section class="py-16 bg-white">
    <x-partials.container>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="relative bg-blue-50 border border-blue-200 rounded-xl shadow-sm p-6 flex flex-col justify-between items-start text-left overflow-hidden">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Busca Propiedades a tu Medida</h3> {{-- CAMBIO: font-semibold --}}
                    <p class="text-gray-700 text-sm leading-relaxed">
                        Encuentra tu inmueble ideal con filtros avanzados.
                    </p> {{-- CAMBIO: Texto más corto --}}
                </div>
                {{-- Espacio para imagen SVG/figura --}}
                <div class="mt-6 w-full h-24 flex justify-end items-end">
            ...
            <div class="relative bg-white border border-blue-200 rounded-xl shadow-sm p-6 flex flex-col justify-between items-start text-left overflow-hidden">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Organiza tus Propiedades Soñadas</h3> {{-- CAMBIO: font-semibold --}}
                    <p class="text-gray-700 text-sm leading-relaxed">
            ...
            <div class="relative bg-blue-50 border border-blue-200 rounded-xl shadow-sm p-6 flex flex-col justify-between items-start text-left overflow-hidden">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Anuncia tu Propiedad sin Costo</h3> {{-- CAMBIO: font-semibold --}}
                    <p class="text-gray-700 text-sm leading-relaxed">
            ...
            <div class="relative bg-white border border-blue-200 rounded-xl shadow-sm p-6 flex flex-col justify-between items-start text-left overflow-hidden">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Asesoría Cuando la Necesites</h3> {{-- CAMBIO: font-semibold --}}
                    <p class="text-gray-700 text-sm leading-relaxed">
