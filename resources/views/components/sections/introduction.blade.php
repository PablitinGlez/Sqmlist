...
<section class="py-16 bg-white" data-scroll-section>
    <x-partials.container>
        ...
        <div class="text-center mb-12" data-scroll-header>
            <h2 id="main-title" class="text-3xl md:text-4xl font-bold text-gray-900 mb-4 initial-hidden">
                Tu hogar perfecto te está esperando
            </h2>
            <p id="main-subtitle" class="text-lg text-gray-600 max-w-3xl mx-auto initial-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16" data-scroll-services>
            <!-- Comprar -->
            <div class="text-center group initial-hidden" data-scroll-card>
...
<style>
    /* Estilos para el estado inicial de los elementos antes de que GSAP los anime */
/* Estilos para SplitText (necesario para que los chars/words se animen individualmente) */
.gsap-char, .gsap-word, .gsap-line {
