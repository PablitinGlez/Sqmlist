{{--
    Esta sección describe los principales servicios ofrecidos por la inmobiliaria:
    comprar, vender y rentar propiedades.
--}}
<section class="py-16 bg-white" data-scroll-section>
    <x-partials.container>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-16" data-scroll-services>
            <!-- Comprar -->
            <div class="text-left md:text-center group initial-hidden" data-scroll-card>
                <div class="bg-blue-50 w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center mb-4 md:mb-6 md:mx-auto group-hover:bg-blue-100 transition-colors duration-300" data-scroll-icon>
            ...
            <!-- Vender -->
            <div class="text-left md:text-center group initial-hidden" data-scroll-card>
                <div class="bg-green-50 w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center mb-4 md:mb-6 md:mx-auto group-hover:bg-green-100 transition-colors duration-300" data-scroll-icon>
            ...
            <!-- Rentar -->
            <div class="text-left md:text-center group initial-hidden" data-scroll-card>
                <div class="bg-purple-50 w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center mb-4 md:mb-6 md:mx-auto group-hover:bg-purple-100 transition-colors duration-300" data-scroll-icon>
