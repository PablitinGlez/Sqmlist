        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-[1.02]">
                ...
                <div class="p-3 md:p-4">
                    ...
                    <a href="{{ route('properties.index', ['ubicacion' => 'Veracruz']) }}" class="text-blue-600 hover:text-blue-700 font-medium flex items-center group text-xs md:text-base" wire:navigate>
                        Ver propiedades
