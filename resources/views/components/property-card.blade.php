...
<div x-data="{ showContactModal: false }">
    ...
    <div class="bg-white rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer border border-gray-200 h-[440px] flex flex-col"
        ...
        <div class="p-3 mt-auto pt-4 flex gap-2 flex-shrink-0">
            @if($property->contact_whatsapp_number)
                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $property->contact_whatsapp_number) }}"
                    ...
                    onclick="event.stopPropagation()">
                    <i class="fab fa-whatsapp mr-1.5 text-base"
                    wire:navigate></i> WhatsApp
                </a>
            @endif
