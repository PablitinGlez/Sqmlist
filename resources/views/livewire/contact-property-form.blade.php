<div>
    ...
    <form wire:submit.prevent="submitForm" class="space-y-4">
        ...
        <div class="flex justify-center mt-6">
            <button
                type="submit"
                class="w-full inline-flex items-center justify-center py-2.5 text-base bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-md shadow-sm transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                wire:loading.attr="disabled"
                wire:target="submitForm"
                x-bind:disabled="!$wire.formIsValid || $wire.showPhoneNumber" {{-- Deshabilitado si ya se mostró el teléfono --}}
            >
                ...
                <span wire:loading wire:target="submitForm" class="inline-flex items-center justify-center">
                    ...
                    <span class="inline-block">Enviando...</span>
                </span>
            </button>
        </div>
    </form>
