...
class CategoryResource extends Resource
{
    ...
    /**
     * Define el esquema del formulario para la creación y edición de categorías.
     */
    ...
    /**
     * Define las columnas y acciones de la tabla para la visualización de categorías.
     */
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                // Filtros definidos para la tabla
            ])
            ->actions([
